...
execute if score @e[tag=snt_shop_sign,sort=nearest,limit=1] snt_shop_test7_lock matches 1 run tag @s remove shop_owner_mode
execute if score @e[tag=snt_shop_sign,sort=nearest,limit=1] snt_shop_test7_lock matches 1 run return 0
...
execute if score @e[tag=snt_shop_sign,sort=nearest,limit=1] snt_shop_test6_owner matches 0 run tellraw @s {"text": "Shop unlocked, relocks once you are further than 32 blocks away or click the sign again!","color": "blue"}
execute if score @e[tag=snt_shop_sign,sort=nearest,limit=1] snt_shop_test6_owner matches 0 run return 0
