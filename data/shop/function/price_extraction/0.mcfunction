...
execute if data storage snt:shop_handling {price:""} run function shop:buy2/failed_shop with entity @s data.shop_data
...
execute if score @s snt_faulty_amount matches 0 run function shop:buy2/failed_shop with entity @s data.shop_data
