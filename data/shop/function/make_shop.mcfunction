...
execute at @s if block ~ ~ ~ #wall_signs[facing=north] unless block ~ ~ ~1 #shop:shop run return 0
execute at @s if block ~ ~ ~ #wall_signs[facing=east] unless block ~-1 ~ ~ #shop:shop run return 0
execute at @s if block ~ ~ ~ #wall_signs[facing=south] unless block ~ ~ ~-1 #shop:shop run return 0
execute at @s if block ~ ~ ~ #wall_signs[facing=west] unless block ~1 ~ ~ #shop:shop run return 0
...
execute as @n[type=marker,tag=snt_potential_shop] at @s align xyz positioned ~0.5 ~0.5 ~0.5 run function shop:potential_new_shop1
