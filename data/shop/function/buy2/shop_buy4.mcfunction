...
execute if score @s snt_shop_test2_check_funds matches 1 if score @s snt_shop_test3_refund_check = @s snt_shop_pricing at @s run function shop_recode:buy2/shop_buy5 with entity @s data.shop_data.item
