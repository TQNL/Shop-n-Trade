...
execute if score @s snt_shop_item_count2 matches ..-1 run function shop:buy2/shop_empty with storage snt:shop_sign2
execute if score @s snt_shop_item_count2 matches ..-1 run return 0
