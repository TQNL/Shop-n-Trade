...
# change sold item? - check only applies to first slot, and ends shop owner mode also with locking
...
execute at @n[tag=snt_shop_sign] if score @n[tag=snt_shop_sign] snt_shop_test6_owner matches 0 run data remove block ^ ^ ^1 Lock
