...
execute as @a[gamemode=survival] at @s unless entity @n[tag=snt_shop_sign,distance=..6] run effect clear @s mining_fatigue
execute as @a[gamemode=adventure] at @s if entity @n[tag=snt_shop_sign,distance=..6] run effect clear @s mining_fatigue
## survival + fatique make opening chests possible, but also placing tnt to grief
...
execute as @a[gamemode=adventure,tag=shop_owner_mode] at @s run function shop:editor
