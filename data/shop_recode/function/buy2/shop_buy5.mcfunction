...
$execute positioned ^ ^ ^1 unless items block ~ ~ ~ container.0 $(item_sign) run item replace block ~ ~ ~ container.0 with air
$execute positioned ^ ^ ^1 unless items block ~ ~ ~ container.1 $(item_sign) run item replace block ~ ~ ~ container.1 with air
$execute positioned ^ ^ ^1 unless items block ~ ~ ~ container.2 $(item_sign) run item replace block ~ ~ ~ container.2 with air
$execute positioned ^ ^ ^1 unless items block ~ ~ ~ container.3 $(item_sign) run item replace block ~ ~ ~ container.3 with air
$execute positioned ^ ^ ^1 unless items block ~ ~ ~ container.4 $(item_sign) run item replace block ~ ~ ~ container.4 with air
$execute positioned ^ ^ ^1 unless items block ~ ~ ~ container.5 $(item_sign) run item replace block ~ ~ ~ container.5 with air
$execute positioned ^ ^ ^1 unless items block ~ ~ ~ container.6 $(item_sign) run item replace block ~ ~ ~ container.6 with air
$execute positioned ^ ^ ^1 unless items block ~ ~ ~ container.7 $(item_sign) run item replace block ~ ~ ~ container.7 with air
$execute positioned ^ ^ ^1 unless items block ~ ~ ~ container.8 $(item_sign) run item replace block ~ ~ ~ container.8 with air
$execute positioned ^ ^ ^1 unless items block ~ ~ ~ container.9 $(item_sign) run item replace block ~ ~ ~ container.9 with air
$execute positioned ^ ^ ^1 unless items block ~ ~ ~ container.10 $(item_sign) run item replace block ~ ~ ~ container.10 with air
$execute positioned ^ ^ ^1 unless items block ~ ~ ~ container.11 $(item_sign) run item replace block ~ ~ ~ container.11 with air
$execute positioned ^ ^ ^1 unless items block ~ ~ ~ container.12 $(item_sign) run item replace block ~ ~ ~ container.12 with air
$execute positioned ^ ^ ^1 unless items block ~ ~ ~ container.13 $(item_sign) run item replace block ~ ~ ~ container.13 with air
$execute positioned ^ ^ ^1 unless items block ~ ~ ~ container.14 $(item_sign) run item replace block ~ ~ ~ container.14 with air
$execute positioned ^ ^ ^1 unless items block ~ ~ ~ container.15 $(item_sign) run item replace block ~ ~ ~ container.15 with air
$execute positioned ^ ^ ^1 unless items block ~ ~ ~ container.16 $(item_sign) run item replace block ~ ~ ~ container.16 with air
$execute positioned ^ ^ ^1 unless items block ~ ~ ~ container.17 $(item_sign) run item replace block ~ ~ ~ container.17 with air
$execute positioned ^ ^ ^1 unless items block ~ ~ ~ container.18 $(item_sign) run item replace block ~ ~ ~ container.18 with air
$execute positioned ^ ^ ^1 unless items block ~ ~ ~ container.19 $(item_sign) run item replace block ~ ~ ~ container.19 with air
$execute positioned ^ ^ ^1 unless items block ~ ~ ~ container.20 $(item_sign) run item replace block ~ ~ ~ container.20 with air
$execute positioned ^ ^ ^1 unless items block ~ ~ ~ container.21 $(item_sign) run item replace block ~ ~ ~ container.21 with air
$execute positioned ^ ^ ^1 unless items block ~ ~ ~ container.22 $(item_sign) run item replace block ~ ~ ~ container.22 with air
$execute positioned ^ ^ ^1 unless items block ~ ~ ~ container.23 $(item_sign) run item replace block ~ ~ ~ container.23 with air
$execute positioned ^ ^ ^1 unless items block ~ ~ ~ container.24 $(item_sign) run item replace block ~ ~ ~ container.24 with air
$execute positioned ^ ^ ^1 unless items block ~ ~ ~ container.25 $(item_sign) run item replace block ~ ~ ~ container.25 with air
$execute positioned ^ ^ ^1 unless items block ~ ~ ~ container.26 $(item_sign) run item replace block ~ ~ ~ container.26 with air
