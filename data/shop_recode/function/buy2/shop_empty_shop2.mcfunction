...
data modify entity @n[tag=snt_shop_sign] data.shop_data.empty_shop_pos.x set string entity @s Pos[0] 0 -3
data modify entity @n[tag=snt_shop_sign] data.shop_data.empty_shop_pos.y set string entity @s Pos[1] 0 -3
data modify entity @n[tag=snt_shop_sign] data.shop_data.empty_shop_pos.z set string entity @s Pos[2] 0 -3
...
tellraw @s [{"text":"item: ","color":"green"},{"nbt":"item_sign","entity":"@n[tag=snt_shop_sign]","color":"white"}]
