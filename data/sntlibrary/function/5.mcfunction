...
# terminate and delete wrong entry when no comma is found (multiple enchants issue)
# `:{` is unique to this level, see how the data structure progresses from there
